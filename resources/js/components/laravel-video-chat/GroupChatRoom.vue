<template>
    <div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <ul class="chat" v-chat-scroll>
                            <li class="clearfix" v-for="message in messages" :key="message.sender.id" v-bind:class="{ 'right' : check(message.sender.id), 'left' : !check(message.sender.id) }">
                            <span class="chat-img" v-bind:class="{ 'pull-right' : check(message.sender.id) , 'pull-left' : !check(message.sender.id) }">
                                ...
                                <div class="chat-body clearfix">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3" v-for="file in message.files" :key="file.id">
        ...
        <div class="row">
            <div class="col-md-3" v-for="file in conversation.files" :key="file.id">
                <img :src="file.file_details.webPath" alt="" class="img-responsive">
                <a :href="file.file_details.webPath" target="_blank" download>Download - {{ file.name }}</a>
            </div>
        </div>
